...
void Voxelizer::voxelize(vector<ofVec3f> pointCloud){
...
void Voxelizer::voxelize(vector<ofVec3f> pointCloud, vector<ofFloatColor> colorCloud){
    numVerts = pointCloud.size() * 24;
...
void Voxelizer::setVoxelSize(ofVec3f _voxelSize){
    voxelSize = _voxelSize/2.0;
}
